...
Confirm that you have [completed the pre-course survey](04-survey.qmd) and let me know on Element that you did not yet receive an email from GitHub to accept the invitation to the `gitforsci-ghe` organization. I will send you an invitation.
:::
...
Copy the full error message and post it in the Element channel. Getting this resolved before the workshop keeps your afternoon free for the interesting parts.
:::
