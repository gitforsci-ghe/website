...
The screenshots on this page were taken during a previous workshop and show the organization name `gitforsci-cis`. For this workshop, read `gitforsci-ghe` wherever a screenshot says `gitforsci-cis`. The steps are identical.
:::
