# {{< fa code-branch >}} Download and install Git

::: {.callout-tip}

If you run into problems with this task, contact me by email: [{{< var email >}}](mailto:{{< var email >}})
...
It's slightly more complicated. Contact me if you have questions.
...
brew install git
```
We will confirm in [Test your setup](06a-clone-repo.qmd) that you have Git installed and working.
