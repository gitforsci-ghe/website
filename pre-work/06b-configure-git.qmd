...
9. Verify that the changes have been pushed to GitHub by refreshing the page for your repository `setup-USERNAME` in your browser (for example, `setup-rainbow-train`). You should see the commit message you just wrote next to `02-git-configuration.R`.
