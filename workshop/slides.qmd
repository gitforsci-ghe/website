...
# Welcome! TODO: hand-wave fa icon {background-color="#0F4C81"}
...
Git -> core
GitHub -> core 
Quarto -> only see, not learn
R -> onle see, not learn
RStudio IDE -> our interface, could also be VS Code, Positron IDE, GitHub Desktop, etc.
:::

## Meeting you where you are

TODO: use data from data/private to recreate these plots for this slide deck
https://github.com/quarto-rdmss-26/website/blob/6fb9bcdc5278995c1512cd52441434da0f49a5fb/1-1-hello-quarto/1-1-hello-quarto.qmd#L174

## What you want to learn {.smaller}

TODO: Recreate similar example using learning_goals column: https://github.com/quarto-rdmss-26/website/blob/6fb9bcdc5278995c1512cd52441434da0f49a5fb/1-1-hello-quarto/1-1-hello-quarto.qmd#L234-L245

## Learner persona

TODO: Write up "Meet Arti" page

image on the right, text on the left. Provide one-liners for each of the four learner personas categories. see also notes of this slide. 

::: {.notes}
TODO: here is my description for above: we have a room full of people with diverse backgrounds and prior experience, the pre-course survey shows that clearly. For some of you, the interface is entirely new, some of you are very experienced. I have learner personas that describe most of you, but my focus learner is Arti. 
:::
...
TODO: I need two icons for learners to idenfiy what happens on RStudio IDE and when they are expected to work on GitHub. Can be fontawesome icons. Or suggest alternatives. 

## Learning objectives

By the end of this workshop, participants will be able to:

TODO: Are these learning objectives fitting Bloom's Taxonomy? I have decided to remove Publish (I will offer a follow-up collaboration on the website repository to create a basic 1-page website with profile links and bio)
...
::: hand
TODO: room-fa-icon: Place the yellow sticky note on your laptop when your map is done. 
TODO: zoom-fa-icon: Write "done" in Zoom Chat.
:::
::::
