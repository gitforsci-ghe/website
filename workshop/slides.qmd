...
::: {.r-stack}
![](images/drawing-1-local-remote-00.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="A local repository on your laptop."}

![](images/drawing-1-local-remote-01.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="A local repository and a remote repository on GitHub, side by side."}

![](images/drawing-1-local-remote-02.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="A clone arrow copying the remote repository down to the local one."}

![](images/drawing-1-local-remote-03.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="Local and remote repositories connected by clone, push, and pull."}
:::
...
::: {.r-stack}
![](images/drawing-2-commit-cycle-00.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="Working files in your project."}

![](images/drawing-2-commit-cycle-01.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="Working files moved to the staging area."}

![](images/drawing-2-commit-cycle-02.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="A commit as a labelled snapshot on the history line."}

![](images/drawing-2-commit-cycle-03.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="A second commit growing the history line."}

![](images/drawing-2-commit-cycle-04.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="The commits pushed from the local history line to the remote."}
:::
...
::: {.r-stack}
![](images/drawing-3-branching-00.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="The main line with a couple of commits."}

![](images/drawing-3-branching-01.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="A dev branch splitting off from main."}

![](images/drawing-3-branching-02.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="Commits landing on the dev branch."}

![](images/drawing-3-branching-03.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="The branch and main lines with the merge point left empty for now."}
:::
...
::: {.r-stack}
![](images/drawing-4-pull-request-00.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="The dev branch and main line with an open merge point."}

![](images/drawing-4-pull-request-01.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="A pull request opened at the join between the branch and main."}

![](images/drawing-4-pull-request-02.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="A human review pausing at the join before the lines meet."}

![](images/drawing-4-pull-request-03.png){.fragment .fade-in width="100%" fig-align="center" fig-alt="The branch merged into main, the lines meeting."}
:::
