...
# Welcome! {{< fa hand >}} {background-color="{{< var brand.section-bg >}}"}
...
# Create and clone {background-color="{{< var brand.section-bg >}}"}
...
# Changes to files: the commit cycle {background-color="{{< var brand.section-bg >}}"}
...
# Team work {background-color="{{< var brand.section-bg >}}"}
...
# Work on a branch {background-color="{{< var brand.section-bg >}}"}
...
# Pull request, review, merge {background-color="{{< var brand.section-bg >}}"}
...
You each take a role, then swap. [Author]{.highlight-yellow} owns the pull request; [Reviewer]{.highlight-yellow} reviews it.
...
# Merge conflict {background-color="{{< var brand.section-bg >}}"}
...
# Concept map revisit and wrap-up {background-color="{{< var brand.section-bg >}}"}
