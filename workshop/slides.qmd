...
<!-- Image spec for Arti: wears a hat with a rainbow on it and a shirt
     with a train on it. Generate via the Hugging Face MCP once connected;
     images/arti-persona.png is a placeholder until then. -->
...
::: {.r-stack}
![](images/drawing-1-local-remote-00.png){.fragment .fade-in width="60%" fig-align="center" fig-alt="A remote repository, drawn as a cloud labelled GitHub, at the top."}

![](images/drawing-1-local-remote-01.png){.fragment .fade-in width="60%" fig-align="center" fig-alt="The remote cloud on top and a local repository box on your laptop below."}

![](images/drawing-1-local-remote-02.png){.fragment .fade-in width="60%" fig-align="center" fig-alt="A clone arrow pointing down from the remote cloud to the local box."}

![](images/drawing-1-local-remote-03.png){.fragment .fade-in width="60%" fig-align="center" fig-alt="Remote cloud on top, local box below, joined by clone and pull arrows pointing down and a push arrow pointing up."}
:::
...
# The commit cycle {background-color="{{< var brand.section-bg >}}"}
...
# Branch {background-color="{{< var brand.section-bg >}}"}
